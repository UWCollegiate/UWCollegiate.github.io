 ...
 * @returns {any}
 */
export function js_solve_once(input) {
    const ret = wasm.js_solve_once(input);
    return ret;
}
 ...
 * @returns {any}
 */
export function js_solve_all(input) {
    const ret = wasm.js_solve_all(input);
    return ret;
}
 ...
 * @returns {any}
 */
export function js_matrix_from_courses(input) {
    const ret = wasm.js_matrix_from_courses(input);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dlx_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
